...
test('TestSuite_04_VO_Regression_CreateSuppWithExcCurr', async ({ page }) => {
    ...
    await test.step("TC_01_VO_Regression_CreateSuppWithExcCurr", async()=>
        {
          await SuppWithExcCurr.SuppWithExcCurrCreation(SuppName+rand,SuppPhone,SuppAddr1,SuppTown,SuppPostCode,SuppCountry,SuppTaxCode,SuppCurrency,SuppPriceBokItem)
